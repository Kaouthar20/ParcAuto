...
$('body').on('click','.btnajouterprestation',function () {
    ...
    if(nbrrow==0){
         $('.tbodylisteprestation tr:last').after('<tr class="table-default"><td data-id="'+idprestation +'">'+typeprestation+'</td><td data-id="'+idtypeprestation +'">'+prestation+'</td><td data-id"'+ idtypevehicule+'">'+typevehicule+'</td><td><button class="btn btndeleteprestation">x</button></td></tr>');
    }
    else{
...
$('body').on('click','.btnajouterprestation_2',function () {
    ...
    let nbrrow= $('.tbodylisteprestation_2 tr > td:contains('+prestation+') ').length;
    if(nbrrow==0){
         $('.tbodylisteprestation_2 tr:last').after('<tr class="table-default"><td data-id="'+idprestation +'">'+typeprestation+'</td><td data-id="'+idtypeprestation +'">'+prestation+'</td><td data-id"'+ idtypevehicule+'">'+typevehicule+'</td><td><button class="btn btndeleteprestation">x</button></td></tr>');
    }
    else{
        alert("prestation deja choisi");
    }
...
$('body').on('click','.addMission',function () {
    ...
    let idDemande;
    idprestation=$('.tbodylisteprestation tr').find('td:eq(0)').map(function(){
    ...
    //     return $(this).attr("data-id");
    //    }).get();
    if(site =="" || demandeur =="" || nbrP =="" || ville =="" || numTel =="" || adresse =="" || dateDepart =="" || dateRetour =="" || Heure =="" ){
...
$('body').on('click','.EditerMission',function () {
    ...
    idprestation=$('body .tbodylisteprestation_2 tr').find('td:eq(0)').map(function(){
        return $(this).attr("data-id");
       }).get();
    $.ajax({
        type: "POST",
...
$("body").on("click" , ".validerprestation" , function() {
  ...
  $('body #data').html('<input at="'+idprestation +'" art="'+idrelation_mission +'" class="form-control data_valide"  id="firstName"  autofocus="" hidden >');
...
$("body").on("click" , "#remise" , function() {
    ...
    {
        $('body #data_remise').html('<div class="mb-3"><label  class="form-label">Remise</label><input class="form-control" type="number" id="remise_data" min="0"  autofocus=""></div>');
...
$.ajax({
                        ...
                        success:function(data) {
                            ...
                            $('body #'+idrelationmission).closest('tr').remove();
